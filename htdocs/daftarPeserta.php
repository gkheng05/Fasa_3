...
if (!$dbManager->isAdmin()) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST" && $_POST["nama"] && $_POST["kataLaluan"] && $_POST["alamat"]) {
        $status = $dbManager->createPeserta($_POST["nama"], $_POST["kataLaluan"], $_POST["alamat"]);
    }
}
?>
<!DOCTYPE html>
