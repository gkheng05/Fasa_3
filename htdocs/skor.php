...
if ($dbManager->checkLoggedIn()) {
    ...
    if (isset($_POST["export"]) && $dbManager->isAdmin()) {
        $export = true;
        ...
        <div class="container my-5">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row align-content-center justify-content-end mr-auto">
                        <form action="/skor.php" method="POST">
                            <button class="btn btn-outline-secondary" type="submit">Export Markah</button>
